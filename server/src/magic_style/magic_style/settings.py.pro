"""
Django settings for magic_style project.
...
SECRET_KEY = 'rswe!3orz++oq@*d&)j4pf0&i_mly9c++76x@60q^od4&0)u9+'
...
WSGI_APPLICATION = 'magic_style.wsgi.application'
...
# Static files (CSS, JavaScript,management Images)
...
SM_RPC_HOST_PORT = 'style_migrate:1600'
...
STYLE_IMAGE_FORTRAIN_PATH = os.path.join(IMAGES_PATH, 'style_image_fortrain')
